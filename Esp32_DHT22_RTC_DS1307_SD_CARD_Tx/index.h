...
<head>
    ...
    const modeaucl = ["Analog Clock", "Digital Clock", "Gif Player"];
...
function GetArduinodata() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
            ...
            auclval   = this.responseXML.getElementsByTagName('analog')[9].childNodes[0].nodeValue;
            cival     = this.responseXML.getElementsByTagName('analog')[10].childNodes[0].nodeValue;
            caval     = this.responseXML.getElementsByTagName('analog')[11].childNodes[0].nodeValue;
    }
    ...
    if(auclval == 0) { 
      document.getElementById("cimesg").innerHTML = "Mode " + caval;
      document.getElementById("auclmesg").innerHTML = "Audio";
      } else { 
        document.getElementById("cimesg").innerHTML = "Mode " + cival;
        document.getElementById("auclmesg").innerHTML = modeaucl[cival-1];
      }
     ...
     <div class="data-input">
       <table>
         <form action="/" method="POST">
            ...
            <td style="width:16%">
                <button class="button-blue" style="width:98%" onclick="myFunctionPatt()"><span id="auclmesg"></span></button></td>
         </form>
        <td style='width:30%'>
     ...
     <div class="data-input">
        <table>
         <form action="/" method="POST">
            ...
            <td style="width:20%">
                <button class="button-blue" style="width:98%" onclick="myFunctionMA()"><span id="ammesg"></span></button>
            </td>
            <td style="width:20%">
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed0" min="1" max="16" value="1" class="slider" id="mySpeed0">
        <button class="button-blue" onclick="myFunctionS0()" style="width:20%"><b><span>Speed</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed1" min="0" max="40" value="7" class="slider" id="mySpeed1">
        <button class="button-blue" onclick="myFunctionS1()" style="width:20%"><b><span>Frame</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed2" min="200" max="750" value="500" class="slider" id="mySpeed2">
        <button class="button-blue" onclick="myFunctionS2()" style="width:20%"><b><span>Volume</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed3" min="1" max="360" value="10" class="slider" id="mySpeed3">
        <button class="button-blue" onclick="myFunctionS3()" style="width:20%"><b><span>Time</span></b></button>
